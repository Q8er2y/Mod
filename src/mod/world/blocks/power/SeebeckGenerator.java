...
import mod.world.graph.GraphConnector.*;
...
public class SeebeckGenerator extends GenericGraphBlock{
    ...
    public class SeebeckGeneratorBuild extends GenericGraphBuild{
        ...
        public void draw(){
            ...
            modDrawf.drawHeat(heat[0],x,y,rotdeg(),leftheat);
            modDrawf.drawHeat(heat[1],x,y,rotdeg(),rightheat);
            modDrawf.drawHeat(heat[2],x,y,rotdeg(),node.getTemp());
            drawTeamTop();
        }
    }
}
