                ...
                getNodes().each((cls, graphNode) -> {
                    for(var con : graphNode.connector){
                        ...
                        cong.getGraph().eachEdge(e -> {
                            ...
                            modDrawf.line(Pal.accent, edge.n1.getNode().build().x, edge.n1.getNode().build().y, edge.n2.getNode().build().x, edge.n2.getNode().build().y);
                        });
