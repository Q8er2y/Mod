...
public class SimpleTransmission extends GenericGraphBlock{
    ...
    public class SimpleTransmissionBuildGeneric extends GenericGraphBuild{
        ...
        public void draw(){
            ...
            //xelo..
            modDrawf.drawRotRect(movingRegions[0], x + ox, y + oy, 16f, 4.5f, 4.5f, fixedRot, graphRot0, graphRot0 + 180f);
            modDrawf.drawRotRect(movingRegions[0], x + ox, y + oy, 16f, 4.5f, 4.5f, fixedRot, graphRot0 + 180f, graphRot0 + 360f);

            modDrawf.drawRotRect(movingRegions[1], x + ox * -0.125f, y + oy * -0.125f, 16f, 4.5f, 4.5f, fixedRot, 360f - graphRot0, 180f - graphRot0);//360-(a+180)
            modDrawf.drawRotRect(movingRegions[1], x + ox * -0.125f, y + oy * -0.125f, 16f, 4.5f, 4.5f, fixedRot, 540f - graphRot0, 360f - graphRot0);//720-(a+180),720-(a+360)

            modDrawf.drawRotRect(movingRegions[2], x - ox, y - oy, 16f, 2.5f, 2.5f, fixedRot, graphRot1, graphRot1 + 180f);
            modDrawf.drawRotRect(movingRegions[2], x - ox, y - oy, 16f, 2.5f, 2.5f, fixedRot, graphRot1 + 180f, graphRot1 + 360f);
