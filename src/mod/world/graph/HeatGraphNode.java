...
import static mod.graphics.modPal.*;
...
public class HeatGraphNode extends GraphNode<HeatGraph>{
    ...
    public void setStats(Stats stats){
        addLevelStat(stats, modStat.emissivity, emissiveness * 60f, new float[]{0.5f, 1f, 3f, 10f, 20f});
        addStat(stats, modStat.heatCapacity, heatcapacity);
        addStat(stats, modStat.heatConductivity, conductivity);
        stats.add(modStat.maxTemperature, maxTemp - celsiusZero, UnityStatUnit.celcius);
    }
}
