...
public final class Tools{
    ...
    public static void main(String[] args){
        ...
        mod = new LoadedMod(null, null, Mod, Tools.class.getClassLoader(), meta);

        Reflect.<Seq<LoadedMod>>get(Mods.class, mods, "mods").add(mod);
        Reflect.<ObjectMap<Class<?>, ModMeta>>get(Mods.class, mods, "metas").put(Mod.class, meta);
